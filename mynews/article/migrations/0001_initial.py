    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publish_date', models.DateTimeField(default=datetime.datetime(2017, 10, 12, 10, 28, 52, 360000), verbose_name=b'\xe5\x8f\x91\xe5\xb8\x83\xe6\x97\xa5\xe6\x9c\x9f')),
                ...
                ('author', models.ForeignKey(verbose_name=b'\xe4\xbd\x9c\xe8\x80\x85', to=settings.AUTH_USER_MODEL,on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': '\u65b0\u95fb\u6587\u7ae0',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_category', models.ForeignKey(to='article.Category',on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['title'],
                'verbose_name': '\u65b0\u95fb\u5b50\u680f\u76ee',
        ...
        migrations.AddField(
            model_name='article',
            name='item',
            field=models.ForeignKey(verbose_name=b'\xe7\xb1\xbb\xe5\x88\xab\xe5\x90\x8d\xe7\xa7\xb0', to='article.Item',on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
